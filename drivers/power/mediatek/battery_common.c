...
extern struct powerdata mcupowerdata;


static void mt_battery_update_EM(struct battery_data *bat_data)
{

	BMT_status.UI_SOC=mcupowerdata.pdata;
...
//-----------------------li fei-----------------	
	if (i==0 && (BMT_status.charger_exist == KAL_TRUE))
		{
		aw2013_breath_all(1,1,1);
		i=1;
		}
	else if(i==1 && (BMT_status.charger_exist == KAL_FALSE))
		{
