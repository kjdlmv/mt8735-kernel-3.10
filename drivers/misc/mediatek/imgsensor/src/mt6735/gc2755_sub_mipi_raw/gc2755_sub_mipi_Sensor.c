...
#include "gc2755_sub_mipi_Sensor.h"
...
kal_bool GC2755_SubDuringTestPattern = KAL_FALSE;

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2755_SUB_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static void sensor_init(void)
{
	...
	//write_cmos_sensor(0x17, 0x16);		//0x14
...
static kal_uint32 open(void)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    GC2755_SubDuringTestPattern = KAL_FALSE; 
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    preview_setting();
	write_cmos_sensor(0x17, 0x16);	
	write_cmos_sensor(0x92, 0x05);//08	
