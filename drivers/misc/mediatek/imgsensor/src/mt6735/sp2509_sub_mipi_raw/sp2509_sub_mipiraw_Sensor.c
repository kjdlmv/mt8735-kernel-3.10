...
#include "sp2509_sub_mipiraw_Sensor.h"
...
{{  1600, 1200,  0, 0, 1600, 1200, 1600, 1200, 0000, 0000, 1600, 1200,  0, 0, 1600, 1200}, // Preview 2112*1558
  ...
  {  1600, 1200,  0, 0, 1600, 1200, 1600, 1200, 0000, 0000, 1600, 1200,  0, 0, 1600, 1200}, // Custom1 (defaultuse preview) 
 ...
 static u32 strtol(const char *nptr, u8 base)
{
 ...
 static u8 SP2509MIPI_Initialize_from_T_Flash()
{
...
{
	LOG_INF("2509 sub Enter sensor_init.\n");
	...
	if(fromsd == 1)//鏄惁浠嶴D璇诲彇//gepeiwei   120903
		SP2509MIPI_Initialize_from_T_Flash();//浠嶴D鍗¤鍙栫殑涓昏鍑芥暟
       else
    #endif
    	{
			write_cmos_sensor(0xfd,0x00);
			...
			write_cmos_sensor(0xa1,0x02);//04
