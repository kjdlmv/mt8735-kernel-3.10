...
#define SP0A09_VALID_IXEL_NUMS            1600
#define SP0A09_VALID_LINE_NUMS            1200
#define SP0A09_DEFAULT_DUMMY_PIXEL_NUMS   0x110 
#define SP0A09_DEFAULT_DUMMY_LINE_NUMS    0x20

#define SP0A09_INTERNAL_DUMMY_PIXEL_NUMS  0
#define SP0A09_INTERNAL_DUMMY_LINE_NUMS   0

#define SP0A09_VIDEO_PERIOD_PIXEL_NUMS          (1160)
#define SP0A09_VIDEO_PERIOD_LINE_NUMS           (1241)
#define SP0A09_PV_PERIOD_PIXEL_NUMS             (1160)
#define SP0A09_PV_PERIOD_LINE_NUMS              (1241)

#define SP0A09_FULL_PERIOD_PIXEL_NUMS           (1160)
#define SP0A09_FULL_PERIOD_LINE_NUMS            (1241)
