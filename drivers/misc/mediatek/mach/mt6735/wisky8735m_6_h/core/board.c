...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
    ...
    struct msdc_hw msdc1_hw = {
        ...
        .data_offset          = 0,
    #ifdef CUST_EINT_MSDC1_INS_NUM
        .flags                = MSDC_SYS_SUSPEND | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_HIGHSPEED | MSDC_UHS1 |MSDC_DDR | MSDC_SD_NEED_POWER, //wisky-lxh@2015062,fix p80k sd card hotplug   
    #else
        .flags                = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_UHS1 |MSDC_DDR,   
    #endif
        .dat0rddly            = 0,
        ...
        .host_function        = MSDC_SD,
        .boot	                = 0,
        .cd_level             = MSDC_CD_LOW,//wisky-lxh@20150611,low trigger
    };
#endif
