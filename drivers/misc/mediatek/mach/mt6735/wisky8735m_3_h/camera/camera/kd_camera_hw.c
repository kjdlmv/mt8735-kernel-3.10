...
u32 pinSet[3][8] = {
	...
	printk("[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
        ...
        if ( currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2145_MIPI_YUV)))
	...
	else if ( currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_SP0A09_MIPI_RAW)))
		{
	...
	mdelay(1);
		...
		else if ( currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_GC5024_MIPI_RAW)))
		{
