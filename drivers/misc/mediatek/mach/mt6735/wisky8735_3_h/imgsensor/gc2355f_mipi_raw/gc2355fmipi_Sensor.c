...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2355F_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17,0x14);//0x17
	...
	/////////////////////////////////////////////////////
	write_cmos_sensor(0x92,0x03);
	write_cmos_sensor(0x94,0x0b);//0x00
