...
#define FAN5405_BUSNUM I2C_SWITHING_CHARGER_CHANNEL
#else
...
static int __init fan5405_subsys_init(void)
{    
    int ret=0;
    
    pr_notice("[fan5405_init] init start. ch=%d\n", FAN5405_BUSNUM);
...
subsys_initcall(fan5405_subsys_init);
