...
static void lcm_init(void)
{
	...
	#ifdef BUILD_LK
    printf("%s,nt35521_qc10 LK \n", __func__);
#else
    printk("%s,nt35521_qc10 kernel", __func__);
#endif
  lcd_reset(1);
  MDELAY(5);
	lcd_reset(0);
...
{
#ifdef BUILD_LK 
		printf("--1->[LK/LCM/nt35521_qc10] lcm_init_power() enter\n");	
		//1.8V
...
#else
		printk("--->[Kernel/LCM/nt35521_qc10] lcm_init_power() enter\n");	
		//1.8V
		lcm_set_gpio_output(GPIO_LCD_V18_EN, GPIO_OUT_ONE);
		MDELAY(5);
		//3.3V
