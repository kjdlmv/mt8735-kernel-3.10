...
#define MIR3DA_SUCCESS						0
#define MIR3DA_ERR_I2C						-1
#define MIR3DA_ERR_STATUS					-3
#define MIR3DA_ERR_SETUP_FAILURE			-4
#define MIR3DA_ERR_GETGSENSORDATA			-5
#define MIR3DA_ERR_IDENTIFICATION			-6
